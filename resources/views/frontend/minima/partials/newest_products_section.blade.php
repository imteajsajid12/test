@if (count($newest_products) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3 border">
        <div class="container">
            ...
            <!-- Products Section -->
            <div class="px-sm-3">
                <div class="aiz-carousel arrow-none sm-gutters-16" data-rows="1" data-items="3" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
